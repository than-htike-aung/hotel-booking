                                           ...
                                           @foreach($slides as $item)
                                             <tr>
                                                ...
                                                <td class="pt_10 pb_10">
                                                    <a href="{{route('admin.slide.edit', $item->id)}}" class="btn btn-primary text-white">Edit</a>
                                                    
                                                    <a href="{{ route('admin.slide.delete', $item->id) }}" class="btn btn-danger" id="delete">Delete</a>
                                                </td>
